...
import { gameArtPublicRoutes, gameArtAdminRoutes } from './routes/game-art.js';
...
await fastify.register(gameArtPublicRoutes, { prefix: '/api' });
await fastify.register(gameArtAdminRoutes,  { prefix: '/api/admin' });
