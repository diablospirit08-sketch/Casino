...
const railItems = [
  ...
  {l:'Vault',        t:'',                               ic:'<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="12" cy="12" r="3"/><path d="M12 9v-2M12 17v-2M9 12H7M17 12h-2"/><circle cx="18.5" cy="8.5" r="1"/></svg>'},
  {l:'Transactions', t:'',                               ic:'<svg viewBox="0 0 46.83 46.39" width="22" height="22"><path fill="#48cae4" d="M8.19 20.25a6.22 6.22 0 0 0-8.19 0V7.97A4.24 4.24 0 0 1 4.19 3.7a4.1 4.1 0 0 1 4 4.1v12.45Z"/><path fill="#560bad" d="M46.81 5.68A5.67 5.67 0 0 0 41.14.01H4.83a5.94 5.94 0 0 1 5.93 5.92v32.4a4.3 4.3 0 0 0 .93 2.66l3.65 4.63a2 2 0 0 0 3.2 0l2.73-3.46a2 2 0 0 1 3.2 0l2.72 3.46a2 2 0 0 0 3.2 0l2.73-3.46a2 2 0 0 1 3.2 0l2.72 3.46a2 2 0 0 0 3.2 0l4-5.11a2.56 2.56 0 0 0 .55-1.57ZM31.7 31.14H16.25a1.5 1.5 0 0 1 0-3H31.7a1.5 1.5 0 1 1 0 3Zm0-5.74H16.25a1.5 1.5 0 0 1 0-3H31.7a1.5 1.5 0 1 1 0 3Zm-13.75-9.87a1.5 1.5 0 1 1 0-3h21.47a1.5 1.5 0 0 1 0 3Zm23.39 15.61h-3.93a1.5 1.5 0 1 1 0-3h3.93a1.5 1.5 0 0 1 0 3Zm0-5.74h-3.93a1.5 1.5 0 1 1 0-3h3.93a1.5 1.5 0 0 1 0 3Z"/></svg>'},
];
...
railLinks.forEach(a=>{
  a.addEventListener('click',e=>{
    ...
    if(a.title==='Vault'){if(typeof openVault!=='undefined')openVault();return;}
