...
const railItems = [
  ...
  {l:'Slots',        t:'sec-slots',     cat:'slots',     ic:'<img src="images/slots-777.png" style="width:30px;height:30px;object-fit:contain">'},
  {l:'Sportsbook',   t:'sportsView',                     ic:'<path d="M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-3.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2zM5 8V7h2v3.82C5.84 10.4 5 9.3 5 8zm14 0c0 1.3-.84 2.4-2 2.82V7h2v1z"/>'},
...
railLinks.forEach(a=>{
  a.addEventListener('click',e=>{
    ...
    if(a.dataset.target==='sportsView'){if(window.openSports)openSports();return;}
    if(document.body.classList.contains('insports')&&window.closeSports)closeSports();
...
function spy(){
  spyTick=false;
  if(document.body.classList.contains('ingame')||document.body.classList.contains('insports'))return;
...
const ROWS = [
  {key:'originals', title:'Volt Originals', icon:'M12 3l2.5 6H21l-5 4 2 7-6-4.5L6 20l2-7-5-4h6.5L12 3Z', iconSvg:`<svg viewBox="0 0 24 24"><polygon points="12,12 14.5,9 21,9" fill="#3E2080"/><polygon points="12,12 16,13 18,20" fill="#3E2080"/><polygon points="12,12 12,15.5 6,20" fill="#3E2080"/><polygon points="12,12 8,13 3,9" fill="#3E2080"/><polygon points="12,12 9.5,9 12,3" fill="#3E2080"/><polygon points="12,12 12,3 14.5,9" fill="#7840B8"/><polygon points="12,12 21,9 16,13" fill="#7840B8"/><polygon points="12,12 18,20 12,15.5" fill="#7840B8"/><polygon points="12,12 6,20 8,13" fill="#7840B8"/><polygon points="12,12 3,9 9.5,9" fill="#7840B8"/></svg>`, games:[
    ...
    {n:'Blackjack', p:'Volt Originals', g:['#1e4878','#2b63d4'], corner:'New'},
  ...
  {key:'slots', title:'Slots', icon:'M5 4h14v16H5zM9 4v16M15 4v16', img:'images/slots-777.png', games:[
    {n:'Sin City',       p:'TaDa Gaming',    g:['#3a2280','#e052b8'], corner:'New', demo:'https://tadagaming.com/PlusTrial/171/en-us'},
    ...
    {n:'Eternal Clash',  p:'Pragmatic Play', g:['#1a3ab0','#5a8ae8'], demo:'https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?lang=en&cur=USD&gameid=vs20olympgate'},
