...
const PAGES={
  ...
  complaint:['Complaint Form',`
    <style>.cf-field{display:flex;flex-direction:column;gap:6px;margin-bottom:14px}.cf-field label{font-size:11px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}.cf-field input,.cf-field select,.cf-field textarea{background:var(--panel-2);border:1px solid var(--line-2);border-radius:8px;color:var(--txt);font-family:inherit;font-size:13px;padding:10px 13px;outline:none;transition:border-color .15s}.cf-field input:focus,.cf-field select:focus,.cf-field textarea:focus{border-color:var(--purple)}.cf-field textarea{resize:vertical;min-height:110px}.cf-field select option{background:var(--panel-2)}#cfErr{font-size:12px;color:#e2596a;min-height:16px;margin-bottom:6px}#cfOk{font-size:12px;color:#4ade80;min-height:16px;margin-bottom:6px}</style>
